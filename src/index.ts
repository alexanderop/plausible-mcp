...
// Define behavioral operators
const behavioralOperators = ["has_done", "has_not_done"] as const;
...
// Metrics that require specific filters or dimensions
// Currently used for documentation purposes
const _metricsWithRequirements = {
...
const sessionMetrics = ['bounce_rate', 'views_per_visit', 'visit_duration'] as const;
type SessionMetric = typeof sessionMetrics[number];
